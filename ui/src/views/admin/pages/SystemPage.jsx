 ...
 *
 * Five groups and seven cards, where this was ten cards in a row. Seven of those ten held a single
...
export default function SystemPage() {
  ...
  return (
    <div className="settingsShell__page">
      ...
      <SegmentPart
        name={t('settings.listingMediaRoot')}
        helpText={t('settings.listingMediaRootHelp')}
        helpMode="popover"
      >
        <Input
          type="text"
          aria-label={t('settings.listingMediaRoot')}
