 ...
 * @property {string[]} [images] All image URLs exposed by the captured search/detail responses.
 * @property {string[]} [attachments] Document URLs exposed by the captured search/detail responses.
 * @property {{
 *   search: {format: 'json'|'html', contentType: string, body: any},
 *   detail: ({format: 'json'|'html', contentType: string, body: any}|null),
 *   detailStatus: 'captured'|'disabled'|'unsupported'|'failed'
 * }} [rawResponse] Provider payload retained for Fredy's internal listing archive.
