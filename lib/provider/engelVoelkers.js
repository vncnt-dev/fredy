...
async function fetchDetails(listing, browser) {
  try {
    ...
    if (detail == null) return withDetailCapture(listing, 'html', html, mediaFromHtml(html));
    ...
    return withDetailCapture(enriched, 'html', html, {
      images: [...pageMedia.images, ...imagesFromJson(detail)],
      attachments: [...pageMedia.attachments, ...attachmentsFromJson(detail)],
    });
  } catch (error) {
